defmodule ElPasssionWorkshopChat.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import ElPasssionWorkshopChat.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&ElPasssionWorkshopChat.ErrorHelpers.translate_error/1)
